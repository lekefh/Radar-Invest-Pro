...
function CardEmpresa({ empresa, onClick }: { empresa: Empresa; onClick: () => void }) {
  ...
  return (
    ...
    >
      ...
      {/* Ticker + nome */}
      <div style={{ display:'flex', alignItems:'center', gap:'10px', marginBottom:'10px', paddingRight:'140px' }}>
        <span style={{ background:'rgba(232,160,32,.15)', border:'1px solid rgba(232,160,32,.3)',
                       borderRadius:'7px', padding:'4px 10px', fontSize:'14px', fontWeight:800, color:'#e8a020' }}>
          {empresa.ticker}
        </span>
        <span style={{ fontSize:'13px', fontWeight:600, color:'#e8edf5' }}>{empresa.nome}</span>
      </div>
            ...
            {([
              ...
              <button
                ...
                style={{
                  ...
                  fontSize:'13px', fontWeight: filtro === key ? 700 : 500,
                  display:'flex', alignItems:'center', gap:'7px', transition:'all .15s',
                }}
              >
