      ...
      <section id="funcionalidades">
        <div className="features">
          ...
          <div className="features-grid">
            ...
            <div className="feat-card reveal"><span className="feat-icon">🏛️</span><h3>Score de Governança</h3><p>10 critérios: estrutura de controle, independência do conselho, tag along, histórico com minoritários, remuneração de longo prazo e nível de listagem na B3.</p><span className="feat-tag">10 critérios · Novo Mercado · ESG</span></div>
