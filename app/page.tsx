      ...
      <section id="funcionalidades">
        <div className="features">
          ...
          <div className="features-grid">
            ...
            <div className="feat-card reveal"><span className="feat-icon">🏛️</span><h3>Score de Governança</h3><p>11 critérios: empresa de dono, estabilidade de controle, independência do conselho, histórico limpo, tag along, alinhamento com minoritários e nível de listagem na B3.</p><span className="feat-tag">11 critérios · Novo Mercado · ESG</span></div>
