...
async function ensureTables() {
  ...
  if (!sbsp3Entrada[0]) {
    await sql`
      INSERT INTO teses_entradas (ticker, trimestre, pld, gsf, rap, pmso, dl_ebitda, lucro, tir_real, observacoes)
      VALUES ('SBSP3','1T26',
        3728, 62.9, 6021, 87, 2.32, 1550, -3.63,
        'Receita adj R$6.021MM (+10,9% a/a). EBITDA adj R$3.786MM (Mg 62,9% +7,5pp a/a). LL adj R$1.550MM (+32,2% a/a). CapEx R$3.728MM (+30,8% a/a). DL R$32.460MM | DL/EBITDA adj LTM 2,32x. 3.524M ações | R$27,42 | MktCap R$96,6B. Privatização Jun/2024 (Equatorial 32%): contrato até 2060 — metas cobertura esgoto >95% SP. Mg EBITDA 35,9%(2023)→62,9%(1T26). REVISÃO 19/06/2026 — 4 de 5 métodos de valuation convergem para CARO no preço atual, considerando o guidance real de CapEx (R$68-70bi até 2029/2030, confirmado via UBS BB/mercado) e ajuste de g_receita por defasagem regulatória RAB: DCF FCFF Base R$4,42 (Bear R$-1,44 | Bull R$12,22; WACC 13,5%, g 4%) — ciclo de CapEx mantém FCL negativo até 2030. TIR Real implícita (FCFF vs. mercado): 3,67% real, PRÊMIO -3,63pp vs NTN-B (vermelho). TIR do Acionista (Div+JCP): 1,46% real, prêmio -6,04pp vs NTN-B (vermelho) — yield bruto de só 2,53% (payout 27%). Gordon (DDM): R$5,73 — também deprimido pelo payout baixo do ciclo de investimento. Graham Number: R$26,69 (~preço atual). Graham Fórmula (g=10%): R$49,00 — única leitura otimista, mas extrapola crescimento de EPS sem ajustar para a compressão de D&A/juros do CapEx pesado; pouco confiável para utility em fase de investimento. Tese revisada: NEUTRO COM VIÉS NEGATIVO no curto prazo — qualidade operacional e RAB de longo prazo são reais, mas o mercado já precifica o Sabesp pós-2030 (RAB madura, dividendos altos), não o Sabesp de hoje (FCL negativo, payout baixo). Reavaliar quando CapEx/Receita cair de forma sustentada (<35%) ou payout subir >50%. Stop: DL/EBITDA >3,5x; Mg EBITDA adj <52%; TIR Real permanecer <NTN-B por 3 trimestres seguidos. Fonte: RI Sabesp + UBS BB (CapEx 2026-28) + recálculo institucional Radar Invest Pro 19/06/2026.')
    `
  }
