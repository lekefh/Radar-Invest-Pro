...
const UNDERLYING: Record<string, string> = {
  ...
  CSNA: 'CSNA3', GGBR: 'GGBR4', USIM: 'USIM5', CMIN: 'CMIN3',
  IRBR: 'IRBR3', BBSE: 'BBSE3', JBSS: 'JBSS3', BEEF: 'BEEF3',
  SMTO: 'SMTO3', CAML: 'CAML3', GOAU: 'GOAU4', RAIZ: 'RAIZ4',
  CSAN: 'CSAN3', POMO: 'POMO4', LEVE: 'LEVE3', EMBR: 'EMBR3',
  AZUL: 'AZUL4', GOLL: 'GOLL4', CVCB: 'CVCB3', LWSA: 'LWSA3',
  TOTS: 'TOTS3', CASH: 'CASH3', POSI: 'POSI3', SQIA: 'SQIA3',
  SOMA: 'SOMA3', LREN: 'LREN3', ARZZ: 'ARZZ3', ALPA: 'ALPA4',
  MRVE: 'MRVE3', EVEN: 'EVEN3', TRIS: 'TRIS3', PLPL: 'PLPL3',
  CXSE: 'CXSE3', IZZB: 'IZZB3', OIBR: 'OIBR3', VIVR: 'VIVR3',
  SBSP: 'SBSP3', CSMG: 'CSMG3', AURE: 'AURE3', CPFE: 'CPFE3',
  RANI: 'RANI3', CSUD: 'CSUD3', SLCE: 'SLCE3', TTEN: 'TTEN3',
  HYPE: 'HYPE3', ODPV: 'ODPV3', DASA: 'DASA3', QUAL: 'QUAL3',
  OBTC: 'OBTC3',
}
